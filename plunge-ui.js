import {plan,resolveLongDay} from './core.js?v=3.15.8';
import {deletePlunge} from './deletion.js?v=3.15.8';
import {clockState,duration,sessions,statistics} from './plunge.js?v=3.15.8';
