const CACHE='hybrid-v3.5.0';
const ASSETS=['./','./index.html','./app.js?v=3.5.0','./wellness.js','./wellness-ui.js','./suggestions.js','./suggestions-ui.js','./training.js','./idle-sync.js','./session.js','./cloud.js','./cloud-api.js','./core.js','./program.js','./style.css?v=3.5.0','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
