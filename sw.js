const CACHE='hybrid-v3.15.7';
const ASSETS=['./deletion.js?v=3.15.7','./plunge.js?v=3.15.7','./plunge-ui.js?v=3.15.7','./','./index.html','./app.js?v=3.15.7','./idle-sync.js?v=3.15.7','./session.js?v=3.15.7','./cloud.js?v=3.15.7','./cloud-api.js?v=3.15.7','./core.js?v=3.15.7','./program.js?v=3.15.7','./training.js?v=3.15.7','./wellness.js?v=3.15.7','./wellness-ui.js?v=3.15.7','./suggestions.js?v=3.15.7','./suggestions-ui.js?v=3.15.7','./style.css?v=3.15.7','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
