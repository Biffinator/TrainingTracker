const CACHE='hybrid-v3.15.8';
const ASSETS=['./deletion.js?v=3.15.8','./plunge.js?v=3.15.8','./plunge-ui.js?v=3.15.8','./','./index.html','./app.js?v=3.15.8','./idle-sync.js?v=3.15.8','./session.js?v=3.15.8','./cloud.js?v=3.15.8','./cloud-api.js?v=3.15.8','./core.js?v=3.15.8','./program.js?v=3.15.8','./training.js?v=3.15.8','./wellness.js?v=3.15.8','./wellness-ui.js?v=3.15.8','./suggestions.js?v=3.15.8','./suggestions-ui.js?v=3.15.8','./style.css?v=3.15.8','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
