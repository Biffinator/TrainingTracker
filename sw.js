const CACHE='hybrid-v3.25.1';
const ASSETS=['./deletion.js?v=3.25.1','./plunge.js?v=3.25.1','./plunge-ui.js?v=3.25.1','./','./index.html','./app.js?v=3.25.1','./idle-sync.js?v=3.25.1','./session.js?v=3.25.1','./cloud.js?v=3.25.1','./cloud-api.js?v=3.25.1','./core.js?v=3.25.1','./program.js?v=3.25.1','./wellness.js?v=3.25.1','./athletica.js?v=3.25.1','./strava.js?v=3.25.1','./reporting.js?v=3.25.1','./reporting-ui.js?v=3.25.1','./suggestions.js?v=3.25.1','./suggestions-ui.js?v=3.25.1','./style.css?v=3.25.1','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
