const CACHE='hybrid-v3.16.4';
const ASSETS=['./deletion.js?v=3.16.4','./plunge.js?v=3.16.4','./plunge-ui.js?v=3.16.4','./','./index.html','./app.js?v=3.16.4','./idle-sync.js?v=3.16.4','./session.js?v=3.16.4','./cloud.js?v=3.16.4','./cloud-api.js?v=3.16.4','./core.js?v=3.16.4','./program.js?v=3.16.4','./training.js?v=3.16.4','./wellness.js?v=3.16.4','./wellness-ui.js?v=3.16.4','./reporting.js?v=3.16.4','./reporting-ui.js?v=3.16.4','./suggestions.js?v=3.16.4','./suggestions-ui.js?v=3.16.4','./style.css?v=3.16.4','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
