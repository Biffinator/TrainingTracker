const CACHE='hybrid-v3.17.0';
const ASSETS=['./deletion.js?v=3.17.0','./plunge.js?v=3.17.0','./plunge-ui.js?v=3.17.0','./','./index.html','./app.js?v=3.17.0','./idle-sync.js?v=3.17.0','./session.js?v=3.17.0','./cloud.js?v=3.17.0','./cloud-api.js?v=3.17.0','./core.js?v=3.17.0','./program.js?v=3.17.0','./training.js?v=3.17.0','./wellness.js?v=3.17.0','./reporting.js?v=3.17.0','./reporting-ui.js?v=3.17.0','./suggestions.js?v=3.17.0','./suggestions-ui.js?v=3.17.0','./style.css?v=3.17.0','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
