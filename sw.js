const CACHE='hybrid-v3.15.5';
const ASSETS=['./deletion.js?v=3.15.5','./plunge.js?v=3.15.5','./plunge-ui.js?v=3.15.5','./','./index.html','./app.js?v=3.15.5','./idle-sync.js?v=3.15.5','./session.js?v=3.15.5','./cloud.js?v=3.15.5','./cloud-api.js?v=3.15.5','./core.js?v=3.15.5','./program.js?v=3.15.5','./training.js?v=3.15.5','./wellness.js?v=3.15.5','./wellness-ui.js?v=3.15.5','./suggestions.js?v=3.15.5','./suggestions-ui.js?v=3.15.5','./style.css?v=3.15.5','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
