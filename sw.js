const CACHE='hybrid-v3.16.1';
const ASSETS=['./deletion.js?v=3.16.1','./plunge.js?v=3.16.1','./plunge-ui.js?v=3.16.1','./','./index.html','./app.js?v=3.16.1','./idle-sync.js?v=3.16.1','./session.js?v=3.16.1','./cloud.js?v=3.16.1','./cloud-api.js?v=3.16.1','./core.js?v=3.16.1','./program.js?v=3.16.1','./training.js?v=3.16.1','./wellness.js?v=3.16.1','./wellness-ui.js?v=3.16.1','./reporting.js?v=3.16.1','./reporting-ui.js?v=3.16.1','./suggestions.js?v=3.16.1','./suggestions-ui.js?v=3.16.1','./style.css?v=3.16.1','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
