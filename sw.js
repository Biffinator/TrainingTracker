const CACHE='hybrid-v3.15.9';
const ASSETS=['./deletion.js?v=3.15.9','./plunge.js?v=3.15.9','./plunge-ui.js?v=3.15.9','./','./index.html','./app.js?v=3.15.9','./idle-sync.js?v=3.15.9','./session.js?v=3.15.9','./cloud.js?v=3.15.9','./cloud-api.js?v=3.15.9','./core.js?v=3.15.9','./program.js?v=3.15.9','./training.js?v=3.15.9','./wellness.js?v=3.15.9','./wellness-ui.js?v=3.15.9','./suggestions.js?v=3.15.9','./suggestions-ui.js?v=3.15.9','./style.css?v=3.15.9','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
