const CACHE='hybrid-v3.14.0';
const ASSETS=['./deletion.js','./plunge.js','./plunge-ui.js?v=3.14.0','./','./index.html','./app.js?v=3.14.0','./idle-sync.js','./session.js','./cloud.js','./cloud-api.js','./core.js','./program.js','./style.css?v=3.14.0','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
