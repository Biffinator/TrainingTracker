const CACHE='hybrid-v3.25.3';
const ASSETS=['./deletion.js?v=3.25.3','./plunge.js?v=3.25.3','./plunge-ui.js?v=3.25.3','./','./index.html','./app.js?v=3.25.3','./idle-sync.js?v=3.25.3','./session.js?v=3.25.3','./cloud.js?v=3.25.3','./cloud-api.js?v=3.25.3','./core.js?v=3.25.3','./program.js?v=3.25.3','./wellness.js?v=3.25.3','./athletica.js?v=3.25.3','./strava.js?v=3.25.3','./reporting.js?v=3.25.3','./reporting-ui.js?v=3.25.3','./suggestions.js?v=3.25.3','./suggestions-ui.js?v=3.25.3','./style.css?v=3.25.3','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
